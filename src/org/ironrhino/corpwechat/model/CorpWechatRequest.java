...
public class CorpWechatRequest implements Serializable {
	...
	private CorpWechatRequestType msgType;
	...
	private CorpWechatEventType event;
	...
	public CorpWechatRequest() {

	}

	public CorpWechatRequest(String xml) {
	...
	public CorpWechatRequestType getMsgType() {
		return msgType;
	}

	public void setMsgType(CorpWechatRequestType msgType) {
	...
	public CorpWechatEventType getEvent() {
		return event;
	}

	public void setEvent(CorpWechatEventType event) {
		this.event = event;
	}
